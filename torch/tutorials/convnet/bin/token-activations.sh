...
###########################################################################
# A sentence or a file containing one sentence per line to be processed
# by the model.
###########################################################################
...
#sentence=sentences-1-0001.txt
#sentence=sentences-1-0002.txt
#sentence=sentences-1-0003.txt
sentence=sentences-8-0001.txt
#sentence=sentences-8-0002.txt
